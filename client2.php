...
<body>
    ...
    <div class="main">
        <h2>Always check your job inbox if there are</h2>
    </div>
    <div class="main2">
        <h2>applicants interested in your project.</h2>
    </div>
    <div class="main3">
        <h2>You have posted a project!</h2>
    </div>
    <div class="back">
        <button onclick="location.href='client1.php'">Back</button>
    </div>
    <div class="project">
        <button onclick="location.href='client3.php'">Project(s)</button>
    </div>
</body>
</html>
